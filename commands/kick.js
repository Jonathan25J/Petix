...
module.exports.run = async (bot, message, args) => {
  ...
  if (!message.guild.me.hasPermission("KICK_MEMBERS")) return message.channel.send("The bot has no permission to do that");
  ...
  message.channel.send(`Are you sure want to kick ${kickUser}?`).then(async msg => {
